...
for(int i=0;i<=6;i++){
    ...
    if(question=="date_limit"){cout<<"What day you take the book?"<<endl;
                                                      ...
                                                      cin>>jour;
                                                       ...
                                                       if (mois==12){mois=1;
                                                        ...
                                                        cout<<endl;
                                                        cout<<jour<<"/"<<mois<<"/"<<annee<<" that's okey??"<<endl;}
   if(question=="good-bye"){cout<<"good bye"<<endl;
                            return 0;}
   if(question=="thanks"){cout<<"your welcome 🙂 🙂 "<<endl;}
   ...
   if(question=="return"){cout<<"you want to go back to the beginning"<<endl;
                            cin>>reponse;
                            if(reponse=="yes"){i=6;
                                                retour=true;
                                                break;}
...
int main()
{
	...
	switch(opt)
	{
		...
		case 2: etudiantmenu();
			break;
        case 3 :
            cout << " This Project made by Ichrak Hamdi, Hammam Ben Younes et Ghaith Farhat \n\n\n\ THANKS FOR USING THIS PROJECT \n\n "; // end
